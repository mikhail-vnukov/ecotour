                     ...
                     foreach($fields as $field)
                        { 
                            ...
                            if($field->idgroup != $idgroup){ 
                                         ...
                                         $menuTabstr .= '<li><a href="#fiedlsattachTab_'.$field->idgroup.'" data-toggle="tab" >'. $field->titlegroup.'</a></li>';
                                         $this->exist =true;
                                    ...
                                    if( JFile::exists($file)){
                                        ...
                                        if ($field->type ==  $plugin_name ) {
                                               ...
                                               //$function  =  "plgfieldsattachment_".$obj."::renderInput(".$id.",".$field->id.",'".$value."','".$field->extras."');";
                                                   ...
                                                   $str .= '<div class="control-group"><label class="control-label">' . $field->title; 
                                                   if($field->required) {$str .= '  <span>(*)</span>';}
                                                   $str .= '</label><div class="controls">'.$tmp.  '</div>';
                                                   $str .= '</div>';
